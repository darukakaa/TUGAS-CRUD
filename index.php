...
<input type="text" class="form-control" name="card_no" placeholder="Enter 12-digit NIM" maxlength="12" required>
</div>
<div class="form-group col-md-6">
			...
			<div class='container' id='profile'> 
				<div class='row'>
					<div class='col-sm-4 col-md-2'>
						<img src='upload_images/$image' alt='' style='width: 120px; height: 150px;' ><br>
